...
Invoke-RestMethod https://raw.githubusercontent.com/kubernetes-sigs/gateway-api/$Version/config/crd/standard/gateway.networking.k8s.io_gateways.yaml > gateway-networking-$Version-gateways.yaml
